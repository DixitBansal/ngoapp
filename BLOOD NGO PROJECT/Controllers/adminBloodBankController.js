...
const update_BloodDetails=async(req,res)=>{
    const response=await ADMIN_BLOOD_BANK_SERVICE.updateBloodDetails(req.body,req.query.bbid);
    res.status(200).send(response);
}
module.exports={viewallBoodBank,addBloodBank,updatedetails,deleteDetails,update_BloodDetails};